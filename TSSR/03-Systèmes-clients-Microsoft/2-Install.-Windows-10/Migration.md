# MigrationLorsque nous installons Windows 10 sur un **nouvel ordinateur** (ex. : renouvellement de parc), il est **essentiel** de recréer un **environnement de travail similaire**.
