# DétailsLes **ACL (Access Control Lists)** permettent de gérer les **permissions sur les fichiers et dossiers** en entreprise. Voici comment elles fonctionnent et comment les configurer efficacement.
