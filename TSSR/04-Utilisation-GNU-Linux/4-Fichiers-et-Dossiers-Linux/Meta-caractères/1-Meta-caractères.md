# Meta-caractèresLes **méta-caractères** permettent de faire des recherches ou manipulations de fichiers plus **flexibles**. C’est un outil **indispensable** dans l’univers Linux.
