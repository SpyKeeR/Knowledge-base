# Redirection dossiers utilisateurLa **redirection de dossiers** permet de **délocaliser des éléments du profil utilisateur** (Documents, Bureau, Téléchargements, etc.) vers un **emplacement réseau** 🗂️
