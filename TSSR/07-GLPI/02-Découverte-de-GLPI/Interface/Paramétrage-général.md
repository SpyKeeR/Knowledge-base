# Paramétrage généralLe **paramétrage général** est le cœur de la configuration de GLPI. Il est principalement réservé aux **super-admins**, mais certains réglages sont personnalisables par chaque utilisateur.
