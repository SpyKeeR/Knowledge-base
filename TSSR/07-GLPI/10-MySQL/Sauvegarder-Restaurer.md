# Sauvegarder / Restaurermysqldump est un outil puissant pour **sauvegarder une base de données** MySQL, en générant un fichier .sql que tu peux rejouer plus tard pour **restaurer** la base.
