# OpenSSLOpenSSL est une boîte à outils open source pour la gestion des protocoles **SSL** et **TLS**, intégrant une **bibliothèque cryptographique** et une **CLI** puissante.
