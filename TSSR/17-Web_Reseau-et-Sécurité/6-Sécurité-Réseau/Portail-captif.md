# Portail captifUn **portail captif** est une interface web s’affichant automatiquement lorsqu’un utilisateur tente de se connecter à Internet via un réseau public ou contrôlé.
