# Gestion des licencesLa gestion des licences dans **M365** est essentielle pour garantir que chaque utilisateur dispose des bons services : **Exchange, OneDrive, Teams, Office, Intune,** etc…
