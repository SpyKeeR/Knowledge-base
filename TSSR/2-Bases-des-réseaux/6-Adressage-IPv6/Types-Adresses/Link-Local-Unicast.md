# Link-Local UnicastUne adresse de monodiffusion de lien local est utilisée pour la communication entre dispositifs sur un même réseau local sans routeur.
