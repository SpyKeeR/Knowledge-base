# TeamingLe **teaming** (ou agrégation de cartes réseau) consiste à **regrouper plusieurs cartes réseau (VMNIC)** d’un hôte ESXi dans un même vSwitch virtuel, afin de :
